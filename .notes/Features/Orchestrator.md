...
- Key Files:
  ...
  - Command entrypoints (thin wiring only): [cmd/crawler/main.go](cmd/crawler/main.go), [cmd/parser/main.go](cmd/parser/main.go), [cmd/scheduler/main.go](cmd/scheduler/main.go)
...
- [ ] Extract reusable crawler logic from cmd/crawler/internal into shared root internal packages.
...
- [ ] Existing crawler/parser command entrypoints remain functional.
